...
function Index() {
  ...
  return (
    <div className="min-h-screen overflow-x-hidden bg-background font-sans text-foreground">
        ...
        <div className="mx-auto grid max-w-6xl grid-cols-1 lg:grid-cols-[1.15fr_1fr]">
          <div className="flex flex-col justify-between border-foreground p-6 sm:p-8 lg:border-r-4 lg:p-12">
            ...
            <div className="py-10 sm:py-12">
              <h1 className="font-display text-[clamp(3.2rem,13vw,8rem)] uppercase leading-[0.82] tracking-tight">
                Vym
                <br />
                Drix
              </h1>
            ...
            <div className="mt-8 flex flex-wrap gap-3">
              <a
                href="#loyihalar"
                className="border-3 border-foreground bg-primary px-5 py-3 font-mono text-[11px] uppercase tracking-[0.2em] text-primary-foreground shadow-hard transition-transform hover:-translate-y-0.5 sm:px-6 sm:text-xs"
              >
                {tr(t.ctaProjects)}
              </a>
              <a
      ...
      {/* ── MARQUEE ──────────────────────────────────── */}
      <div className="overflow-hidden border-b-4 border-foreground bg-foreground py-3">
      ...
      <section className="mx-auto max-w-6xl border-b-4 border-foreground px-6 py-12 sm:px-8 sm:py-16 lg:px-12">
        ...
        <div className="grid gap-5 sm:gap-6 md:grid-cols-2">
          {skills.map((s) => (
            <article
              key={s.num}
              className={`${s.tone} border-3 border-foreground p-5 shadow-hard transition-transform hover:-translate-y-1 sm:p-7`}
            >
      ...
      <section id="loyihalar" className="border-b-4 border-foreground">
        <div className="mx-auto max-w-6xl px-6 pt-12 sm:px-8 sm:pt-16 lg:px-12">
          <div className="mb-8 flex flex-wrap items-end justify-between gap-x-6 gap-y-2 border-b-3 border-foreground pb-4 sm:mb-10">
            ...
            <span className="font-script text-2xl text-primary sm:text-3xl">{tr(t.selected)}</span>
          </div>
          ...
          <div className="grid gap-5 pb-12 sm:gap-6 sm:pb-16 md:grid-cols-2">
            {projects.map((p) => (
              <button
                ...
                type="button"
                onClick={() => setActive(p)}
                className="group flex flex-col border-3 border-foreground bg-background p-5 text-left shadow-hard transition-transform hover:-translate-y-1 sm:p-7"
              >
                <div className={`${p.tone} -mx-5 -mt-5 mb-5 border-b-3 border-foreground px-5 py-3 sm:-mx-7 sm:-mt-7 sm:mb-6 sm:px-7`}>
        ...
        <div className="mx-auto grid max-w-6xl grid-cols-1 lg:grid-cols-[auto_1fr]">
          <div className="flex justify-center border-b-4 border-foreground p-8 lg:border-b-0 lg:border-r-4 lg:p-12">
            <img
              ...
              width={512}
              height={512}
              className="animate-spin-slow size-36 rounded-full border-3 border-foreground object-cover sm:size-48"
            />
          </div>
